...
let arrayPalabras =["CASTILLA", "BOSA", "BAVARIA", "CIBILK", "CORABASTOS", "TINTAL"];
//Arreglo que contiene las ayudas de cada palabra
let ayudas = [
    "¿Donde queda la parroquia del Padre Chucho?",
    "Localidad cercana a Kennedy",
    "Antigua cervecería sobre la Av. Boyacá",
    "Programa para personas con discapacidad y cuidadores",
    "Central mayorista más grande de Bogotá",
    "Nombre de biblioteca más grande de Kennedy"
]
...
function cargarNuevaPalabra(){
    ...
    if(cantPalabrasJugadas>6){
        ...
        arrayPalabras =["CASTILLA", "BOSA", "BAVARIA", "CIBILK", "CORABASTOS", "TINTAL"];
        ayudas = [
            "¿Donde queda la parroquia del Padre Chucho?",
            "Localidad cercana a Kennedy",
            "Antigua cervecería sobre la Av. Boyacá",
