...
if (arreglo.every(element => element !== "")) {
    ...
    const isSuccess = arreglo[0] === "zero" && arreglo[1] === "one" && arreglo[2] === "Two" && arreglo[3] === "three" && arreglo[4] === "four" && arreglo[5] === "five" && arreglo[6] === "six" && arreglo[7] === "seven" && arreglo[8] === "eight" && arreglo[9] === "nine" && arreglo[10] === "ten" && arreglo[11] === "eleven";
