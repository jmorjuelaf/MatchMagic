...
if (arreglo.every(element => element !== "")) {
    ...
    const isSuccess = arreglo[0] === "black" && arreglo[1] === "blue" && arreglo[2] === "brown" && arreglo[3] === "gray" && arreglo[4] === "green" && arreglo[5] === "orange" && arreglo[6] === "pink" && arreglo[7] === "purple" && arreglo[8] === "red" && arreglo[9] === "violet" && arreglo[10] === "white" && arreglo[11] === "yellow";
