...
if (arreglo.every(element => element !== "")) {
    ...
    const isSuccess = arreglo[0] === "apple" && arreglo[1] === "banana" && arreglo[2] === "bird" && arreglo[3] === "book" && arreglo[4] === "car" && arreglo[5] === "cat" && arreglo[6] === "dog" && arreglo[7] === "house" && arreglo[8] === "pear" && arreglo[9] === "pencil" && arreglo[10] === "pineapple" && arreglo[11] === "rabbit";
