...
if (arreglo.every(element => element !== "")) {
    ...
    const isSuccess = arreglo[0] === "Chorro_quevedo" && arreglo[1] === "Entre_nubes" && arreglo[2] === "Jardin_botanico" && arreglo[3] === "Monserrate" && arreglo[4] === "Museo_nacional" && arreglo[5] === "Museo_oro" && arreglo[6] === "Parque_simon_bolivar" && arreglo[7] === "Planetario_bogota" && arreglo[8] === "Plaza_bolivar" && arreglo[9] === "Trasmicable" && arreglo[10] === "Tren_sabana" && arreglo[11] === "Virgilio_barco";
